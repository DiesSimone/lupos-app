...
function Register() {
    ...
    return (
        <div className='formWrapper'>
            ...
            <input type="text" className="form-input" value={name} id="username" onChange={handleName} placeholder='Enter your username' required/><br />
            <input type="email" className="form-input" value={email} id="email" onChange={handleMail} placeholder='Enter your email' required/><br />
            <input type="password" className="form-input" value={password} id="password" onChange={handlePassword} placeholder='Enter your password' required/><br />
