...
import { userCreation, userLogging, getUsername, createTask, createHabit, habitValue ,getTasks, getToken, deleteToken, deleteTask, checkTask, editHabit, deleteHabit, getHabits } from '../controllers/api_controller'
...
router.get("/gethabits", AuthenticateToken, getHabits);
...
router.post("/deletehabit", AuthenticateToken, deleteHabit);
